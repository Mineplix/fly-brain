...
export class ArenaBatches {
  ...
  // Release a fly's instances back to the batch. Without this a removed fly keeps its slots
  // forever and the batch fills up after `capacity` spawns even though flies have been deleted.
  remove(fly) {
